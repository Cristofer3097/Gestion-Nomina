...
<!-- Delete -->
        <div id="eliminarordinance<?php echo $row['empid'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    ...
    <form class="form-horizontal" method="POST" action="employee_delete.php">
                ...
                <input type="hidden" id="del_attid" name="id" value="<?php echo $row['empid'];?>">
        ...
        <div id="updateordinance<?php echo $row['empid'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
